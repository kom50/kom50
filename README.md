...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,materialui,redux,vue,pinia,nuxtjs,sass,tailwind,nodejs,express,mongodb,firebase,supabase,git,github,postman,vscode,vite,netlify,vercel,py,java,docker)](https://skillicons.dev)
